...
button1_img = pygame.image.load('img/button1.png').convert_alpha()
button2_img = pygame.image.load('img/button2.png').convert_alpha()
button3_img = pygame.image.load('img/button3.png').convert_alpha()
button4_img = pygame.image.load('img/button4.png').convert_alpha()
button5_img = pygame.image.load('img/button5.png').convert_alpha()
button6_img = pygame.image.load('img/button6.png').convert_alpha()
button7_img = pygame.image.load('img/button7.png').convert_alpha()
button8_img = pygame.image.load('img/button8.png').convert_alpha()
button9_img = pygame.image.load('img/button9.png').convert_alpha()
...
button2 = button.Button(400, 125, button2_img, 0.40)
button3 = button.Button(715, 125, button3_img, 0.40)
button4 = button.Button(85, 250, button4_img, 0.40)
button5 = button.Button(400, 250, button5_img, 0.40)
button6 = button.Button(715, 250, button5_img, 0.40)
button7 = button.Button(85, 375, button5_img, 0.40)
button8 = button.Button(400, 375, button5_img, 0.40)
button9 = button.Button(715, 375, button5_img, 0.40)
