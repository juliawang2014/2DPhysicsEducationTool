...
class BouncyBalls(object):
    ...
    Brendan here, hahaha I copied Julia's code, then I copied brendans code lmao
    """
    ...
    def __init__(self) -> None:
        ...
        size='input size'
        text_box_update = pygame_gui.elements.UITextEntryLine(relative_rect=pygame.Rect((80, 500), (250, 50)),manager=self.manager)
        text_box_update.set_allowed_characters('numbers')
