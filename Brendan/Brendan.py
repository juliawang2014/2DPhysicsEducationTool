...
class BouncyBalls(object):
    ...
    def __init__(self) -> None:
        ...
        self.ui_textbox = pygame_gui.elements.ui_text_box.UITextBox(html_text="Gravity: ", relative_rect=pygame.Rect((300, 540), (250, 50)), manager=self.manager, object_id="gravityInfoTextBox")
        self.time_delta = 0.0
